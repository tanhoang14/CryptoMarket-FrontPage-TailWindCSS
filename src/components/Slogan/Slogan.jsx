import Cards from "../../assets/desktop/crypto.svg";
const Slogan = () => {
  return (
    <section className="text-36 relative my-14 font-extrabold md:my-28 md:grid md:grid-cols-3 md:items-center md:text-48">
      <div className="text-center md:col-span-1 md:col-start-2">
        <p className="">
          Buy <span className="text-purple-300"> Crypto </span>
        </p>
      ...
      <div className="mt-[69px] ml-[120px] md:absolute md:right-[-5rem]">
        <img src={Cards} width={"50%"} alt="credit card" />
      </div>
    </section>
  );
};
